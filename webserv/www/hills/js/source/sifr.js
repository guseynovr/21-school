...
var sIFR = new function() {
  ...
  function DomUtil(sIFR) {
    ...
    this.getViewport = function() {
      return {
        width:  window.innerWidth  || document.documentElement.ClientHandlerWidth  || this.getBody().ClientHandlerWidth,
        height: window.innerHeight || document.documentElement.ClientHandlerHeight || this.getBody().ClientHandlerHeight
      };
    };

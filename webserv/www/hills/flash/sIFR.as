...
class sIFR {
  ...
  //= Whether kerning is enabled by default. This can be overriden from the ClientHandler side.
  ...
  //= Default value which can be overriden from the ClientHandler side.
  ...
  public static var defaultOpacity:Number        = -1; // Use ClientHandler settings
  //= Default value which can be overriden from the ClientHandler side.
  //  See also <http://livedocs.macromedia.com/flash/8/main/wwhelp/wwhimpl/common/html/wwhelp.htm?context=LiveDocs_Parts&file=00002788.html>.
  public static var defaultBlendMode:Number      = -1; // Use cliest settings
  //= Overrides the grid fit type as defined on the ClientHandler side.
  ...
  //  filters defined on the ClientHandler. You can add additional filters here so they'll be supported
  //  when defined on the ClientHandler.
  ...
  public static function checkDomain():Boolean {
    ...
    var domain = (new LocalClientHandler()).domain();
